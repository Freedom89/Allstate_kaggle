...
ids.to_csv("./input/ids_1106.csv",index_label= None)
train_x.to_csv("./input/train_1106.csv",index_label=None)
train_y.to_csv("./input/train_1106.csv",index_label=None, header=None )
test_x.to_csv("./input/test_1106.csv",index_label= None )
